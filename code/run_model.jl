...
params = Dict("beta" => .99, "eta" => 0.032, 
	"g1" => .000177, "g2" =>.0044, "g31" => .000, "g32" => .016,  "g33" => .16,  
	"pr1" => 1.0/3.0, "pr2" => 1.0/3.0,  "pr3" => 1.0/3.0,
	"Y0" => 1.2, "K0" => 100.0, "Emin" => 1.0, "Emax" => 50.0, "E0" => 0.0, "Leontieff" => 0.0);
...
plot_model(resbase, res1, scat=false)
...
plot_model(res, resbase, scat=false)
